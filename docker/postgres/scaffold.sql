...
CREATE TABLE IF NOT EXISTS app.waitlist_entries (
    ...
    preferred_date_start        timestamp with time zone NOT NULL,
    preferred_date_end          timestamp with time zone NOT NULL,
    preferred_appointment_type  character varying(64)    NOT NULL DEFAULT '',
